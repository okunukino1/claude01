...
- 作業開始基準は最新 `origin/main` のコミット `0945aca18daae24f1236219965235a55356b303f`。
- 安定版は引き続き **v2026.07.10-1**。新機能は反映していない。
- テスト版は **v2026.06.24-test.94**。Google地図でも、素早く2回タップして2回目の指を離さず上下へ動かす一指ズームを追加した。上へ動かすと縮小、下へ動かすと拡大する。
