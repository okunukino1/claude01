...
- 作業開始基準は最新 `origin/main` のコミット `19580d55106b05e464903b9f0fbae47c99d213e9`。
- 安定版は引き続き **v2026.07.10-1**。新機能は反映していない。
- テスト版は **v2026.06.24-test.92**。最新版のインストール型Androidアプリで戻る三角をアプリ内で受け取り、写真拡大中は編集画面へ、`配送先を編集` の表示中はマップへ戻る。
